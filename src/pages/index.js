        ...
        <>
            ...
            <section className='flex items-center justify-around flex-col lg:flex-row'>
                <div className="lg:h-[320px] text-center border-2 p-4 rounded-md m-4 w-full lg:w-[50%]">
                    ...
                    <a onClick={() => plausible('[CLICK] - Subscribe Tool')} href="/subscribe-link" className="text-blue-500 mx-4 my-8 flex items-center text-lg font-bold uppercase hover:underline rounded-md w-full justify-center">View Tool <ArrowRight size={32} className='ml-2' /></a>
                </div>
                <div className="lg:h-[320px] text-center border-2 p-4 rounded-md m-4 w-full lg:w-[50%]">
                    ...
                    <a onClick={() => plausible('[CLICK] - Shorten Tool')} href="/link-shortener" className="text-blue-500 mx-4 my-8 flex items-center text-lg font-bold uppercase hover:underline rounded-md w-full justify-center">View Tool <ArrowRight size={32} className='ml-2' /></a>
                </div>
            </section>
            <hr className="my-4" />
        </>
